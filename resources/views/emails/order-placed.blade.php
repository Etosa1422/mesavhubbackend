          ...
          <tr>
            <td style="padding:40px;">
                ...
                <tr>
                  <td style="padding:20px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Link</td>
                        <td style="padding:6px 0;font-size:13px;color:#14532d;word-break:break-all;">{{ $order->link }}</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Amount Charged</td>
                        <td style="padding:6px 0;font-size:14px;color:#15803d;font-weight:800;">{{ $user->currency ?? '' }} {{ number_format($order->price, 2) }}</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Status</td>
                        <td style="padding:6px 0;">
                          <span style="display:inline-block;background:#dcfce7;color:#15803d;font-size:12px;font-weight:700;padding:3px 10px;border-radius:50px;">
              ...
              <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.6;">
                We'll notify you as soon as there's an update on your order. If you have any questions, please contact our support team.<br /><br />
