        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(22,163,74,0.1);">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#15803d,#16a34a,#22c55e);padding:36px 40px;text-align:center;">
              ...
              <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:13px;">Wallet Funded Successfully</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 28px;font-size:14px;color:#374151;line-height:1.7;">
                Your wallet has been credited successfully. Here are your payment details:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
                <tr>
                  <td align="center" style="background:linear-gradient(135deg,#15803d,#16a34a);border-radius:10px;padding:24px;">
                    <p style="margin:0;color:rgba(255,255,255,0.8);font-size:13px;">Amount Credited</p>
                    <p style="margin:6px 0 0;color:#ffffff;font-size:36px;font-weight:800;">
                      {{ $transaction->currency ?? ($user->currency ?? '') }} {{ number_format($transaction->amount, 2) }}
                    </p>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="padding:20px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;width:160px;">Transaction ID</td>
                        <td style="padding:6px 0;font-size:13px;color:#14532d;font-weight:700;">{{ $transaction->transaction_id }}</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Payment Method</td>
                        <td style="padding:6px 0;font-size:13px;color:#14532d;">{{ ucfirst($transaction->payment_method ?? 'N/A') }}</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">New Balance</td>
                        <td style="padding:6px 0;font-size:14px;color:#15803d;font-weight:800;">
                          {{ $user->currency ?? '' }} {{ number_format($user->fresh()->balance, 2) }}
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Date</td>
                        <td style="padding:6px 0;font-size:13px;color:#14532d;">{{ $transaction->created_at->format('M d, Y — H:i') }}</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:13px;color:#166534;font-weight:600;">Status</td>
                        <td style="padding:6px 0;">
                          <span style="display:inline-block;background:#dcfce7;color:#15803d;font-size:12px;font-weight:700;padding:3px 10px;border-radius:50px;">Completed</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.6;">
                If you did not initiate this payment, please contact support immediately.<br /><br />
